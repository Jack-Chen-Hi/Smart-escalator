...
* @{
*/
#define PRODUCT_KEY "20cd26a6513c49d3ab1a1403fffa69ef"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "0cd2e44ca3994c84bd40b32ed32a20db"
...
* @{
*/
#define stop_start_BYTEOFFSET                    0
#define stop_start_BITOFFSET                     0
#define stop_start_LEN                           1
#define motor_status_BYTEOFFSET                    1
#define motor_status_BITOFFSET                     0
#define motor_status_LEN                           2
#define fault_BYTEOFFSET                    1
#define fault_BITOFFSET                     2
#define fault_LEN                           1

#define people_sum_RATIO                         1
#define people_sum_ADDITION                      0
#define people_sum_MIN                           0
#define people_sum_MAX                           10000
/**@} */
...
typedef enum
{
    stop_start_VALUE0 = 0,//紧急停止
    stop_start_VALUE1 = 1,//启动
    stop_start_VALUE_MAX,
} stop_start_ENUM_T;
typedef enum
{
    motor_status_VALUE0 = 0,//停止
    motor_status_VALUE1 = 1,//低速
    motor_status_VALUE2 = 2,//高速
    motor_status_VALUE_MAX,
} motor_status_ENUM_T;
typedef enum
{
    fault_VALUE0 = 0,//否
...
typedef struct {
    uint32_t valuestop_start;
    uint32_t valuemotor_status;
    uint32_t valuefault;
    uint32_t valuepeople_sum;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
    uint8_t flagstop_start:1;
} attrFlags_t;
